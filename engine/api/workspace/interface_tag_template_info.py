    ...
    "msg": "request successfully"
        ...
        try:
            try:
                ...
                logger.debug('FN:getTagTemplateList user_key:{} account_id:{} workspace_id:{}'.format(user_key,account_id,workspace_id))

            except:
                data = response_code.GET_DATA_FAIL
                data['msg'] = 'Token error or expired, please login again.'
                logger.error("FN:interfaceTagTemplateList_get error:{}".format(traceback.format_exc()))
