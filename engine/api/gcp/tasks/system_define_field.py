...
class system_define_field(baseTask, DbBase):
    ...
    def execute(self, workspace_id=None, form_id=None, input_form_id=None, user_id=None):
        ...
        if len(missing_set) != 0:
            ...
            condition = "label='%s' and workspace_id='%s'" % (field_name, workspace_id)
            ...
            if not dynamic_field_info:
                ...
                field_fields = ('workspace_id', 'style', 'form_id', 'label', 'default_value', 'placeholder',
                                   'value_num', 'create_time')
                values = (workspace_id, '2', form_id, field_name, option_label, option_label, 1, now)
                ...
                condition = "dynamic_field_id=%s and option_label='%s'" % (dynamic_field_id, option_label)
            ...
            field_fields = ('dynamic_field_id', 'input_form_id', 'option_label', 'option_value', 'create_time')
            values = (dynamic_field_id, input_form_id, option_label, options_value, now)
