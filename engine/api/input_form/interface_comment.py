...
class interfaceComment(Resource):
    ...
    def post(self,):
        ...
        try:
            ...
            logger.error("FN:interfaceComment_post error:{}".format(traceback.format_exc()))
    ...
    def delete(self, ):
        ...
        try:
            ...
            logger.error("FN:interfaceComment_delete error:{}".format(traceback.format_exc()))
    ...
    def put(self,):
        ...
        try:
            ...
            logger.error("FN:interfaceComment_put error:{}".format(traceback.format_exc()))
            error_data = response_code.ADD_DATA_FAIL
            return response_result_process(error_data, xml=xml)
