...
class DbUseCaseMgr(DbBase):
    ...
    def get_usecase_info_by_ad_group(self, account_id):
        ...
        try:
            ...
            for index, usecase_info in enumerate(usecase_infos):
                ...
                resource_access_items = json.loads(usecase_info['RESOURCES_ACCESS_LIST'], strict=False)
    ...
    def get_usecase_details_info_by_id(self, workspace_id, usecase_id):
        ...
        try:
            ...
            user_form_fields = json.loads(self.execute_fetch_one(conn, sql)['fields_list'], strict=False)
            ...
            for input_form_id in user_input_form_id:
                ...
                user_input_form_fields = json.loads(self.execute_fetch_one(conn, sql)['form_field_values_dict'], strict=False)
            ...
            for index in range(len(data_access_infos)):
                data_access_infos[index]['fields'] = json.loads(data_access_infos[index]['fields'], strict=False)
